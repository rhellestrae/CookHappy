...
namespace CookHappyRetro {
	...
	/// </summary>
	public class CookHappyJuneInput : NSObject, IMLFeatureProvider
	{
	...
	/// </summary>
	public class CookHappyJuneOutput : NSObject, IMLFeatureProvider
	{
		static readonly NSSet<NSString> featureNames = new NSSet<NSString> (
		...
		public CookHappyJuneOutput (NSDictionary<NSObject, NSNumber> loss, string classLabel)
		{
			if (loss == null)
	...
	/// </summary>
	public class CookHappyJune : NSObject
	{
		readonly MLModel model;

		static NSUrl GetModelUrl ()
		{
			return NSBundle.MainBundle.GetUrlForResource ("CookHappyJune", "mlmodelc");
		}

		public CookHappyJune ()
		{
			NSError err;
		...
		CookHappyJune (MLModel model)
		{
			this.model = model;
		}

		public static CookHappyJune Create (NSUrl url, out NSError error)
		{
			if (url == null)
		...
		public static CookHappyJune Create (NSUrl url, MLModelConfiguration configuration, out NSError error)
		{
			if (url == null)
				throw new ArgumentNullException (nameof (url));
		...
		/// <param name="error">If an error occurs, upon return contains an NSError object that describes the problem.</param>
		public CookHappyJuneOutput GetPrediction (CVPixelBuffer data, out NSError error)
		{
