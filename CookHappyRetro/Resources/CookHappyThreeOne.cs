...
namespace CookHappyRetro {
	...
	/// </summary>
	public class CookHappyThreeOneInput : NSObject, IMLFeatureProvider
	{
		...
		public CookHappyThreeOneInput (CVPixelBuffer data)
		{
			if (data == null)
	...
	/// </summary>
	public class CookHappyThreeOneOutput : NSObject, IMLFeatureProvider
	{
		static readonly NSSet<NSString> featureNames = new NSSet<NSString> (
		...
		public CookHappyThreeOneOutput (NSDictionary<NSObject, NSNumber> loss, string classLabel)
		{
			if (loss == null)
	...
	/// </summary>
	public class CookHappyThreeOne : NSObject
	{
		readonly MLModel model;

		static NSUrl GetModelUrl ()
		{
			return NSBundle.MainBundle.GetUrlForResource ("CookHappyThreeOne", "mlmodelc");
		}

		public CookHappyThreeOne ()
		{
			NSError err;
		...
		CookHappyThreeOne (MLModel model)
		{
			this.model = model;
		}

		public static CookHappyThreeOne Create (NSUrl url, out NSError error)
		{
			if (url == null)
			...
			return new CookHappyThreeOne (model);
		}

		public static CookHappyThreeOne Create (MLModelConfiguration configuration, out NSError error)
		{
		...
		public static CookHappyThreeOne Create (NSUrl url, MLModelConfiguration configuration, out NSError error)
		{
			if (url == null)
				throw new ArgumentNullException (nameof (url));
		...
		/// </summary>
		/// <param name="input">an instance of CookHappyThreeOneInput to predict from</param>
		/// <param name="error">If an error occurs, upon return contains an NSError object that describes the problem.</param>
		public CookHappyThreeOneOutput GetPrediction (CookHappyThreeOneInput input, out NSError error)
		{
			if (input == null)
			...
			return new CookHappyThreeOneOutput (lossValue, classLabelValue);
		}
		...
		/// <param name="error">If an error occurs, upon return contains an NSError object that describes the problem.</param>
		public CookHappyThreeOneOutput GetPrediction (CookHappyThreeOneInput input, MLPredictionOptions options, out NSError error)
		{
			if (input == null)
				throw new ArgumentNullException (nameof (input));
		...
		/// <param name="error">If an error occurs, upon return contains an NSError object that describes the problem.</param>
		public CookHappyThreeOneOutput GetPrediction (CVPixelBuffer data, out NSError error)
		{
			var input = new CookHappyThreeOneInput (data);
		...
		/// <param name="options">prediction options</param>
		/// <param name="error">If an error occurs, upon return contains an NSError object that describes the problem.</param>
		public CookHappyThreeOneOutput GetPrediction (CVPixelBuffer data, MLPredictionOptions options, out NSError error)
		{
			var input = new CookHappyThreeOneInput (data);
