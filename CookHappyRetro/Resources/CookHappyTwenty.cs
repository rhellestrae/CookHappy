...
namespace CookHappyRetro {
	...
	/// </summary>
	public class CookHappyTwentyInput : NSObject, IMLFeatureProvider
	{
		...
		public CookHappyTwentyInput (CVPixelBuffer data)
		{
			if (data == null)
	...
	/// </summary>
	public class CookHappyTwentyOutput : NSObject, IMLFeatureProvider
	{
		static readonly NSSet<NSString> featureNames = new NSSet<NSString> (
		...
		public CookHappyTwentyOutput (NSDictionary<NSObject, NSNumber> loss, string classLabel)
		{
			if (loss == null)
	...
	/// </summary>
	public class CookHappyTwenty : NSObject
	{
		readonly MLModel model;

		static NSUrl GetModelUrl ()
		{
			return NSBundle.MainBundle.GetUrlForResource ("CookHappyTwenty", "mlmodelc");
		}

		public CookHappyTwenty ()
		{
			NSError err;
		...
		CookHappyTwenty (MLModel model)
		{
			this.model = model;
		}

		public static CookHappyTwenty Create (NSUrl url, out NSError error)
		{
			if (url == null)
			...
			return new CookHappyTwenty (model);
		}

		public static CookHappyTwenty Create (MLModelConfiguration configuration, out NSError error)
		{
		...
		public static CookHappyTwenty Create (NSUrl url, MLModelConfiguration configuration, out NSError error)
		{
			if (url == null)
				throw new ArgumentNullException (nameof (url));
		...
		/// </summary>
		/// <param name="input">an instance of CookHappyTwentyInput to predict from</param>
		/// <param name="error">If an error occurs, upon return contains an NSError object that describes the problem.</param>
		public CookHappyTwentyOutput GetPrediction (CookHappyTwentyInput input, out NSError error)
		{
			if (input == null)
			...
			return new CookHappyTwentyOutput (lossValue, classLabelValue);
		}
		...
		/// <param name="error">If an error occurs, upon return contains an NSError object that describes the problem.</param>
		public CookHappyTwentyOutput GetPrediction (CookHappyTwentyInput input, MLPredictionOptions options, out NSError error)
		{
			if (input == null)
				throw new ArgumentNullException (nameof (input));
		...
		/// <param name="error">If an error occurs, upon return contains an NSError object that describes the problem.</param>
		public CookHappyTwentyOutput GetPrediction (CVPixelBuffer data, out NSError error)
		{
			var input = new CookHappyTwentyInput (data);
		...
		/// <param name="options">prediction options</param>
		/// <param name="error">If an error occurs, upon return contains an NSError object that describes the problem.</param>
		public CookHappyTwentyOutput GetPrediction (CVPixelBuffer data, MLPredictionOptions options, out NSError error)
		{
			var input = new CookHappyTwentyInput (data);
